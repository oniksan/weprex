...
#ifndef WSMODBUSRTUPROTOCOL_H
#define WSMODBUSRTUPROTOCOL_H
...
class WSModbusRTUProtocol : public WSAbstractRRProtocol {
Q_OBJECT

public:
	WSModbusRTUProtocol(quint32 bufferSize = 255);
...
private:
	std::unique_ptr<struct modbus_rtu_client_handler, void(*)(struct modbus_rtu_client_handler*)> m_hModbusClient;
